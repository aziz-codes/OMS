...
$query="SELECT customer_message AND supplier_message FROM chat WHERE supplier='$supplier_id'";
...
<div class="show-messages">
	<?php echo $row['customer_message']; ?>
	<br>
	<?php echo $row['supplier_message'];  ?>
</div>
