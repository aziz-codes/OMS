...
<div class="side-nav" style="background-color:  #e6e6e6;">
  <h5 style="padding: 5px 0; background-color: #fff;">Set your filter:</h5>
...
<br>
    <a href="xiaomi.php"style="text-decoration: none;">Xiaomi</a>
<br>
  ...
  <form method="POST" action="specific_result.php">
      <div style="border: 1px solid black;">
        <h4>Search By</h4>
    <input type="text" name="RAM" placeholder="RAM" style="width: 60px;"> &nbsp;&nbsp;&nbsp;
    <input type="text" name="Internal" placeholder="Internal" style="width: 60px;"><br><br>
    <input type="text" name="brand" placeholder="Brand" style="width: 140px;"><br><br>
    <input type="text" name="price" placeholder="Price from" style="width: 100px;">&nbsp;&nbsp;&nbsp;&nbsp;
    <input type="text" name="price" placeholder="Price to" style="width: 100px;">
    <br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
if(isset($_POST['add_to_cart']))
 ...
 ?>
 <?php  
                //$product_name=$_POST['other'];
                $ram=$_POST['RAM'];
                $internal=$_POST['Internal'];
                $brand=$_POST['brand'];
                $price_to=$_POST['price_from'];
                $price_to=$_POST['price_to'];
                $query = "SELECT * FROM products WHERE RAM='%$ram'";  
  ...
  <div class="card-body">
      <a href="OMS_Chat.php?action=add&supplier=<?php echo $row['supplier_id']; ?>"><?php echo $row['supplier_id']; ?>
    </a>
    ...
    <input type="submit" name="add_to_cart" value="Add to Cart" class="btn btn-success">
       ...
       <?php 
                ...
                {
                  echo "no result found for ".$product_name;
                }
                ?>  
</div>
</form>
